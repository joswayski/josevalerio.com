  ...
  return (
    <BlogShell>
      <p className="">
        ...
        digging through logs for your current task, you'll discover a strange
        issue that affects a small percentage of users in a specific region, but
        only on the weekends.
        <span className="font-bold">
          {" "}
          If it takes less than an hour to fix, you should tackle it as part of
          your current task.
        </span>
      </p>
      <p className="pt-8">
        ...
        " I hear you say "<span className="italic">It's out of scope!</span>". I
        promise you it's not a big deal, you can do both. Don't make a Jira
